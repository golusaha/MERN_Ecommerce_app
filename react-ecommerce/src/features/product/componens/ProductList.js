        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                          ...
                          {products.map((product) => (
                            <Link to="product-detail">
                              <div key={product.id} className="group relative border-solid border-2 border-gray-200 p-2">
                                <div className="aspect-h-1 min-h-80 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                                  <img
                                ...
                                <div className="mt-4 flex justify-between">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                      < StarIcon style={{ color: 'golden' }} className='h-6 w-6 inline'></StarIcon>
              ...
              {/* section of products and fitlters ends */}
